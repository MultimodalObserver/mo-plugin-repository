...
Plugin.create! :id => 2, :categories => [ c1, c2, c3 ], :name => "Plugin name 2", :short_name => 'PLUGIN-2', :description => short, :user_id => 1, :repo_type => :github, :repo_user => "   felovilches   ", :repo_name => "mo-plugin-repository   ", :home_page => "https://www.facebook.com/felo.vilches"
Plugin.create! :id => 3, :categories => [ c4, c6 ], :name => "Plugin name 3 (Bitbucket)", :short_name => 'plugin-3', :description => chinese, :user_id => 1, :repo_type => :bitbucket, :repo_user => " bitbucket_user  ", :repo_name => "mo-plugin-repository", :home_page => "https://www.facebook.com/felo.vilches"
Plugin.create! :id => 4, :categories => [ c7, c9 ], :name => "Plugin name 4", :short_name => 'plugin-4', :description => html, :user_id => 2, :repo_type => :github, :repo_user => "  shouldBEALLloWCase  ", :repo_name => "mo-plugin-repository", :home_page => "https://www.facebook.com/felo.vilches"
...
Plugin.create! :id => 6, :name => "Plugin name 6 <b>HTML</b>", :short_name => 'plugin-6', :description => lorem, :user_id => 2, :repo_type => :bitbucket, :repo_user => "felovilches", :repo_name => "mo-plugin-repository", :home_page => "https://www.facebook.com/felo.vilches"
Plugin.create! :id => 7, :categories => [ c5, c7 ], :name => "Plugin name 7", :short_name => 'plugin-7', :description => short, :user_id => 2, :repo_type => :github, :repo_user => "felovilches", :repo_name => "mo-plugin-repository", :home_page => "https://www.facebook.com/felo.vilches"
...
Plugin.create! :id => 9, :categories => [ c2, c6 ], :name => "Plugin name 9", :short_name => 'plugin-9', :description => chinese, :user_id => 2, :repo_type => :github, :repo_user => "felovilches", :repo_name => "mo-plugin-repository", :home_page => "https://www.facebook.com/felo.vilches"
Plugin.create! :id => 10, :categories => [ c3, c8 ], :name => "Plugin name 10", :short_name => 'plugin-10', :description => multiline, :user_id => 3, :repo_type => :github, :repo_user => "felovilches", :repo_name => "mo-plugin-repository", :home_page => "https://www.facebook.com/felo.vilches"
Plugin.create! :id => 11, :categories => [ c4 ], :name => "Plugin name 11", :short_name => 'plugin-11', :description => html, :user_id => 3, :repo_type => :github, :repo_user => "felovilches", :repo_name => "mo-plugin-repository", :home_page => "https://www.facebook.com/felo.vilches"
Plugin.create! :id => 12, :categories => [ c6 ], :name => "Plugin name 12", :short_name => 'plugin-12', :description => multiline, :user_id => 4, :repo_type => :github, :repo_user => "felovilches", :repo_name => "mo-plugin-repository"
Plugin.create! :id => 13, :name => "Plugin name 13", :short_name => 'plugin-13', :description => short, :user_id => 5, :repo_type => :bitbucket, :repo_user => "felovilches", :repo_name => "mo-plugin-repository", :home_page => "https://www.facebook.com/felo.vilches"
