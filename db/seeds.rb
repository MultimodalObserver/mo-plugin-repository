...
Plugin.create! :id => 3, :categories => [ c4, c6 ], :name => "Plugin name 3", :short_name => 'plugin-3', :description => lorem, :user_id => 1, :repo_type => :github, :repo_user => "felovilches", :repo_name => "mo-plugin-repository", :home_page => "https://www.facebook.com/felo.vilches"
Plugin.create! :id => 4, :categories => [ c7, c9 ], :name => "Plugin name 4", :short_name => 'plugin-4', :description => lorem, :user_id => 2, :repo_type => :github, :repo_user => "felovilches", :repo_name => "mo-plugin-repository", :home_page => "https://www.facebook.com/felo.vilches"
