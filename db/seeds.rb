...
Plugin.create! :id => 3, :tags => [ c4, c6 ], :name => "Plugin name 3 (Bitbucket)", :short_name => 'plugin-3', :description => chinese, :user_id => 1, :repo_type => :bitbucket, :repo_user => " bitbucket_user  ", :repo_name => "mo-plugin-repository", :home_page => "https://www.facebook.com/felo.vilches"
