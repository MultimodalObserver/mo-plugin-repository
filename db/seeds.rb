...
Plugin.create! :id => 14, :tags => [ c3, c4, c5, c6 ], :name => "Atom", :short_name => 'atom', :description => "IDE Atom. Repositorio de ejemplo aunque no sea un Plugin de MO.", :user_id => 5, :repo_type => :github, :repo_user => "atom", :repo_name => "atom", :home_page => "https://ide.atom.io/"
